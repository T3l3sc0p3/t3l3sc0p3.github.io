...
img_path: '/assets/img/writeups/uoftctf/2024/'
image:
  path: logo.png
---
...
![Good Luck](introduction/good-luck.png)
...
![Baby's First IoT Introduction](iot/babys-first-iot-introduction.png)
...
![](miscellaneous/out-of-the-bucket-1.png)
...
![baby's first pyjail](jail/babys-first-py-jail.png)
...
![](jail/babys-first-py-jail-flag.png)
...
![macro](forensics/enableme-macro.png)
...
![Request](web/voice-changer-2.png)
...
![Injection](web/voice-changer-3.png)
...
![The Varsity](web/the-varsity.png)
...
![Flag](web/the-varsity-4.png)

`Flag: uoftctf{w31rd_b3h4v10r_0f_parseInt()!}`

## No Code (362 pts)

![No Code](web/no-code.png)
